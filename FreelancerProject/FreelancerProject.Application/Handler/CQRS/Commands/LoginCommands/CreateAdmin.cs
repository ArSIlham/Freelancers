...
namespace FreelancersProject.Application.Handler.CQRS.Commands.LoginCommands
{
	public class CreateAdmin
	{
		...
		public class CreateAdminRequest : IRequest<BaseResponses<ApplicationUser>>
		{
			[Required]
		...
		public class SignInHandler : IRequestHandler<CreateAdminRequest, BaseResponses<ApplicationUser>>
		{
